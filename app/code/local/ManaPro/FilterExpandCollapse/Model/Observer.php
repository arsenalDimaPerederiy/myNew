...
class ManaPro_FilterExpandCollapse_Model_Observer
{
    ...
    public function addFields($observer)
    {
        ...
        /* @var $fieldsetRenderer Mana_Admin_Block_Crud_Card_Fieldset */
        $fieldsetRenderer =
            $layout->getBlockSingleton(strtolower('Mana_Admin/Crud_Card_Fieldset'));
        /* @var $fieldRenderer Mana_Admin_Block_Crud_Card_Field */
        $fieldRenderer =
        ...
        /* @var $t ManaPro_FilterHelp_Helper_Data */
        $t = Mage::helper(strtolower('ManaPro_FilterExpandCollapse'));
