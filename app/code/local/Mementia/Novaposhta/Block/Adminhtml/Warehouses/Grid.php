<?php
class Mementia_Novaposhta_Block_Adminhtml_Warehouses_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        /** @var $collection Mementia_Novaposhta_Model_Resource_Warehouse_Collection */
