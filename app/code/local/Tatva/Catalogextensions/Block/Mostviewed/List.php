...
//	                )
					array(
	                   'flat.name AS name', 'flat.small_image AS small_image', 'flat.url_key AS url_key', 'flat.url_path AS url_path', 'flat.price AS price','flat.special_price as special_price','flat.special_from_date AS special_from_date','flat.special_to_date AS special_to_date'
					)
	        );
		}
