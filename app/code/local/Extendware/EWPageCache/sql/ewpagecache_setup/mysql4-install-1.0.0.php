...
try {
	$incompatModules = array('BalkeTechnologies_StoreMaintenance', 'Fooman_Speedster', 'GT_Speed', 'Fooman_SpeedsterEnterprise', 'Fooman_SpeedsterAdvanced', 'Diglin_UIOptimization', 'Jemoon_Htmlminify', 'Nexcessnet_Turpentine', 'Brim_PageCache');
