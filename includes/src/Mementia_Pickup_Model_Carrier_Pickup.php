<?php
class Mementia_Pickup_Model_Carrier_Pickup
    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        $cityId = Mage::app()->getRequest()->getPost('city_id', ""); //  city ID
        $city = Mage::getModel('store_pickup/city')->load($cityId);
        $cityName = $city->getNameRu(); // city name

        $warehouseId = Mage::app()->getRequest()->getPost('warehouse_id', ""); //  warehouse ID
        $warehouse = Mage::getModel('store_pickup/warehouse')->load($warehouseId);
        $warehouseName = $warehouse->getNameRu(); // warehouse name
        ...
        $method->setCarrier($this->_code)
            ...
            ->setMethod('city_')
            ->setMethodTitle($cityName." - ".$warehouseName)
