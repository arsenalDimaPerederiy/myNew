        ...
        return Mana.Object.extend('Mana/Core/Ajax', {
            ...
            get: function (url, callback, options) {
                ...
                $.get(this._encodeUrl(url, options))
                    .done(function (response) {
                        self._done(response, callback, options, url);
                    })
                    .fail(function (error) {
                        self._fail(error, options, url)
                    })
                    .complete(function () {
            ...
            post: function (url, data, callback, options) {
                ...
                $.post(window.encodeURI(url), data)
                    .done(function (response) {
                        self._done(response, callback, options, url, data);
                    })
                    .fail(function (error) {
                        self._fail(error, options, url, data)
                    })
                    .complete(function () {
                        self._complete(options, url, data);
                    });
            },
            ...
            _before: function (options, url, data) {
                ...
                $(document).trigger('m-ajax-before', [
                    [],
                    url,
                    '',
                    options
