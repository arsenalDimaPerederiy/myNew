 ...
 */
(function($) {
    jQuery.fn.collapsible = function (cmd, arg) {
        ...
        if (typeof cmd == 'string') {
            return jQuery.fn.collapsible.dispatcher[cmd](this, arg);
        }
        
        //return the command dispatcher
        return jQuery.fn.collapsible.dispatcher['_create'](this, cmd);
    };

    //create the command dispatcher
    jQuery.fn.collapsible.dispatcher = {
    ...
    function createCollapsible(obj, options)
    {
        ...
        var opts = jQuery.extend({}, jQuery.fn.collapsible.defaults, options);
    ...
    function openAll($this, opts) {
        ...
        jQuery.each($this, function(elem, value) {

            if (collapsed(jQuery(value), opts)) {

                //open a closed element
                open(jQuery(value), opts);
            }
        });
    }
    ...
    function useCookies(opts) {
        ...
        if (!jQuery.cookie || opts.cookieName == '') {
            return false;
        }
    ...
    function appendCookie(value, opts) {
        ...
        //get the cookie
        var cookie = decodeURIComponent(jQuery.cookie(opts.cookieName));
    ...
    function setCookie(value, opts)
    {
        ...
        jQuery.cookie(opts.cookieName, value, opts.cookieOptions);
    ...
    function inCookie(value, opts)
    {
        ...
        var cookieIndex = jQuery.inArray(value, cookieArray);
    ...
    function issetCookie(opts)
    {
        ...
        //is the cookie set
        if (jQuery.cookie(opts.cookieName) === null) { //no, quit here
            return false;
        }
    ...
    function inDefaultOpen(id, opts)
    {
        ...
        var index = jQuery.inArray(id, defaultOpen);
    ...
    // settings
    jQuery.fn.collapsible.defaults = {
