...
(function(jQuery) {
    ...
    jQuery.jcarousel = function(e, o) {
        ...
        if (!windowLoaded && jQuery.browser.safari) {
        ...
        dimension: function(e, d) {
            ...
            if (d == null) {
                return !this.options.vertical ?
                       (el.outerWidth(true) || jQueryjc.intval(this.options.itemFallbackDimension)) :
                       (el.outerHeight(true) || jQueryjc.intval(this.options.itemFallbackDimension));
            } else {
